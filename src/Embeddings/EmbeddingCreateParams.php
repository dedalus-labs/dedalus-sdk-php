...
use DedalusSDK\Embeddings\EmbeddingCreateParams\Input;
use DedalusSDK\Embeddings\EmbeddingCreateParams\Model;

/**
 * Create embeddings using the configured provider.
 *
 * @see DedalusSDK\Services\EmbeddingsService::create()
 *
 * @phpstan-import-type InputVariants from \DedalusSDK\Embeddings\EmbeddingCreateParams\Input
