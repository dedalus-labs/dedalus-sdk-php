...
use DedalusSDK\Chat\Completions\CompletionCreateParams\SafetySetting\Category;
use DedalusSDK\Chat\Completions\CompletionCreateParams\SafetySetting\Threshold;
