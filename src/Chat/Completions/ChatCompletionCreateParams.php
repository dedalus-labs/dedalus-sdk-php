...
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Credentials;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\MCPServers;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Message;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Model;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\PromptMode;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\ResponseFormat;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\SafetySetting;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Speed;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Stop;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\SystemInstruction;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Thinking;
use DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Thinking\ThinkingConfigAdaptive;
 ...
 *
 * @phpstan-import-type ModelVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Model
 * @phpstan-import-type CredentialsVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Credentials
 * @phpstan-import-type MCPServersVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\MCPServers
 * @phpstan-import-type MessageVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Message
 * @phpstan-import-type ResponseFormatVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\ResponseFormat
 * @phpstan-import-type StopVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Stop
 * @phpstan-import-type SystemInstructionVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\SystemInstruction
 * @phpstan-import-type ThinkingVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Thinking
 * @phpstan-import-type ToolChoiceVariants from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\ToolChoice
 * @phpstan-import-type ModelShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Model
 * @phpstan-import-type ChatCompletionAudioParamShape from \DedalusSDK\Chat\Completions\ChatCompletionAudioParam
 * @phpstan-import-type CredentialsShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Credentials
 * @phpstan-import-type ChatCompletionFunctionsShape from \DedalusSDK\Chat\Completions\ChatCompletionFunctions
 * @phpstan-import-type MCPServersShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\MCPServers
 * @phpstan-import-type MessageShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Message
 * @phpstan-import-type PredictionContentShape from \DedalusSDK\Chat\Completions\PredictionContent
 * @phpstan-import-type ResponseFormatShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\ResponseFormat
 * @phpstan-import-type SafetySettingShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\SafetySetting
 * @phpstan-import-type StopShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Stop
 * @phpstan-import-type SystemInstructionShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\SystemInstruction
 * @phpstan-import-type ThinkingShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\Thinking
 * @phpstan-import-type ToolChoiceShape from \DedalusSDK\Chat\Completions\ChatCompletionCreateParams\ToolChoice
 * @phpstan-import-type ChatCompletionToolParamShape from \DedalusSDK\Chat\Completions\ChatCompletionToolParam
 *
 * @phpstan-type ChatCompletionCreateParamsShape = array{
 *   model: ModelShape,
 ...
 * }
 */
final class ChatCompletionCreateParams implements BaseModel
{
    /** @use SdkModel<ChatCompletionCreateParamsShape> */
    use SdkModel;
    ...
    /**
     * `new ChatCompletionCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ChatCompletionCreateParams::with(model: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ChatCompletionCreateParams)->withModel(...)
     * ```
     */
