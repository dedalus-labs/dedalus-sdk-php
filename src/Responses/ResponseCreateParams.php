...
use DedalusSDK\Responses\ResponseCreateParams\Conversation\ResponseConversationParam;
use DedalusSDK\Responses\ResponseCreateParams\Credentials;
use DedalusSDK\Responses\ResponseCreateParams\Input;
use DedalusSDK\Responses\ResponseCreateParams\Instructions;
use DedalusSDK\Responses\ResponseCreateParams\MCPServers;
use DedalusSDK\Responses\ResponseCreateParams\Model;
use DedalusSDK\Responses\ResponseCreateParams\Prompt;
use DedalusSDK\Responses\ResponseCreateParams\ServiceTier;
use DedalusSDK\Responses\ResponseCreateParams\ToolChoice;
use DedalusSDK\Responses\ResponseCreateParams\Truncation;

/**
 * Responses request schema with Dedalus extensions.
 *
 * @phpstan-import-type ConversationVariants from \DedalusSDK\Responses\ResponseCreateParams\Conversation
 * @phpstan-import-type CredentialsVariants from \DedalusSDK\Responses\ResponseCreateParams\Credentials
 * @phpstan-import-type InputVariants from \DedalusSDK\Responses\ResponseCreateParams\Input
 * @phpstan-import-type InstructionsVariants from \DedalusSDK\Responses\ResponseCreateParams\Instructions
 * @phpstan-import-type MCPServersVariants from \DedalusSDK\Responses\ResponseCreateParams\MCPServers
 * @phpstan-import-type ModelVariants from \DedalusSDK\Responses\ResponseCreateParams\Model
 * @phpstan-import-type ToolChoiceVariants from \DedalusSDK\Responses\ResponseCreateParams\ToolChoice
 * @phpstan-import-type ConversationShape from \DedalusSDK\Responses\ResponseCreateParams\Conversation
 * @phpstan-import-type CredentialsShape from \DedalusSDK\Responses\ResponseCreateParams\Credentials
 * @phpstan-import-type InputShape from \DedalusSDK\Responses\ResponseCreateParams\Input
 * @phpstan-import-type InstructionsShape from \DedalusSDK\Responses\ResponseCreateParams\Instructions
 * @phpstan-import-type MCPServersShape from \DedalusSDK\Responses\ResponseCreateParams\MCPServers
 * @phpstan-import-type ModelShape from \DedalusSDK\Responses\ResponseCreateParams\Model
 * @phpstan-import-type PromptShape from \DedalusSDK\Responses\ResponseCreateParams\Prompt
 * @phpstan-import-type ToolChoiceShape from \DedalusSDK\Responses\ResponseCreateParams\ToolChoice
 *
 * @phpstan-type ResponseCreateParamsShape = array{
 ...
 * }
 */
final class ResponseCreateParams implements BaseModel
{
    /** @use SdkModel<ResponseCreateParamsShape> */
    use SdkModel;
