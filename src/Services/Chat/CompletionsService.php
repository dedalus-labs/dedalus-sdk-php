...
use DedalusSDK\ServiceContracts\Chat\CompletionsContract;
 ...
 */
final class CompletionsService implements CompletionsContract
{
    /**
     * @api
     */
    public CompletionsRawService $raw;
    ...
    {
        $this->raw = new CompletionsRawService($client);
    }
    ...
    public function create(
        ...
        $params = Util::removeNulls(
            [
                ...
                'audio' => $audio,
                'automaticToolExecution' => $automaticToolExecution,
