...
use DedalusSDK\ServiceContracts\Audio\SpeechContract;
 ...
 */
final class SpeechService implements SpeechContract
{
    /**
     * @api
     */
    public SpeechRawService $raw;
    ...
    {
        $this->raw = new SpeechRawService($client);
    }
