...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "git@github.com:dedalus-labs/dedalus-sdk-php.git"
    }
  ],
  "require": {
...
See [the contributing documentation](https://github.com/dedalus-labs/dedalus-sdk-php/tree/main/CONTRIBUTING.md).
